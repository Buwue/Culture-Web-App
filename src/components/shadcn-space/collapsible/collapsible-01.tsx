    ...
    <div className="w-full max-w-lg space-y-2">
      {releases.map((release) => {
        ...
        return (
          ...
          >
            <div className="overflow-hidden rounded-xl bg-background outline">
              <CollapsibleTrigger className="flex h-auto w-full justify-between rounded-none px-4 py-3 hover:bg-muted/50">
              ...
              <CollapsibleContent className="overflow-hidden data-[state=closed]:animate-collapsible-up data-[state=open]:animate-collapsible-down">
                <div className="space-y-2.5 border-t px-4 py-3">
                  <Bubble className="h-full w-full max-w-[100%] justify-start">
                    <SmoothButton variant="outline">
                      <div className="transition-colors duration-300">a</div>
